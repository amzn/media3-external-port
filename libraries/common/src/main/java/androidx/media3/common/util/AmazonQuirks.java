...
public class AmazonQuirks {
    ...
    private static void loadForcedLogSettings() {
        String setting = getSystemProperty("com.amazon.media3.forcelog");
        // this happens on release builds, and without disabling sentenforce
    ...
    // for debugging purpose only, so it is a minimalistic solution
