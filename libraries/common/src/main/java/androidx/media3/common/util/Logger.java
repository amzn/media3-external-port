...
public class Logger {
    ...
    /**
     * Configure the log levels for a specific module
     ...
     *      android.util.Log. i.e. Log.ERROR, Log.WARNING, Log.INFO, Log.DEBUG and Log.VERBOSE logs.
     *      Info, error and warning logs are always printed.
     *      Setting to Log.INFO, Log.ERROR, Log.Warning etc disables DEBUG and VERBOSE.
     *      Setting to Log.VERBOSE prints Debugs and Verbose logs.
    ...
    /**
     * Function to print debug level logs. Print only
